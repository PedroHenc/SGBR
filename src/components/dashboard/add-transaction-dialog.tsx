...
import type { Transaction, Category, TransactionType, Collaborator } from '@/lib/types';
...
export function AddTransactionDialog({ type, categories, collaborators, onAddTransaction }: AddTransactionDialogProps) {
